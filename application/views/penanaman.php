				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-md-4">
							<label>Satuan</label>
							<select name="satuan" class="form-control txt">
						...
						<div class="form-group col-md-12">
							...
							<div class="input-group">
								...
								<input type="number" class="form-control txt" name="estimasi_biaya" placeholder="Estimasi Biaya" aria-label="kodemk" aria-describedby="basic-addon1">
							</div>
						</div>
...
<script>
	...
	$('tbody').on('click', '.edit', function() {
		...
		$('#my-modal [name="jumlah_tanam"]').val(parseInt(data[8]));
		$('#my-modal [name="satuan"]').val(data[8].slice(-2));
		$('#my-modal [name="status_penanaman"]').val(data[9]);
		$('#my-modal [name="kebutuhan"]').val(data[10]);
		$('#my-modal [name="estimasi_biaya"]').val(est.replace(/\./g, ''));
		$('#my-modal').modal({
			keyboard: false,
			backdrop: 'static',
		});
